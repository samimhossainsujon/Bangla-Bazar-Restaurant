...
const Footer = () => {
  return (
    <div className="mt-24 w-11/12 md:10/12 mx-auto text-center
     bg-gray-300 rounded-lg px-2 md:p-6">
      <footer>
        <div>
          <div className="font-extrabold  
         flex flex-col md:flex-row justify-center">
            <span className="text-lg md:text-3xl text-center text-black">
          ...
          <div>
            <p>Copyright © 2023 - by Bangla Bazar & Restaurant</p>
          </div>
